...
def generate_launch_description():
    ...
    xacro_file = PathJoinSubstitution([pkg_magni_gazebo,
                                       'urdf',
                                       'magni.urdf.xacro'])
    ...
    robot_description_package = 'magni_gazebo'
    ...
    urdf_path = os.path.join(pkg_magni_gazebo, "urdf", urdf_file_name)
